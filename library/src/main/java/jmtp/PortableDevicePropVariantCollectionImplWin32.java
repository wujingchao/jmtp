...
class PortableDevicePropVariantCollectionImplWin32 implements COMReferenceable {
    ...
    public PortableDevicePropVariantCollectionImplWin32() throws COMException {
    ...
    public native void add(PropVariant pv) throws COMException;
    public native void clear() throws COMException;
    public native long count() throws COMException;
    public native PropVariant getAt(long index) throws COMException;
    public native void removeAt(long index) throws COMException;
}
