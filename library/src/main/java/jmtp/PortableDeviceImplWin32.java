...
class PortableDeviceImplWin32 implements PortableDevice {
    ...
    public native long nativeInitEventCookie();
    public native void registerForEventNotification(PortableDeviceEventCallbackImplWin32 callback);
    public native void unregisterForEventNotification();
    ...
    public long getNativeEventCookie() {
        return pEventCookie;
    }
